    ...
    <section className="h-full">
      <div className="container mx-auto h-full pt-8 xl:pt-12">
        ...
        <div className="flex flex-col gap-8 px-14">
          <p>
            Hi, my name is <TextHighlight text="Tin" />, I&apos;m 23 years old.
            I got a bachelor of Electronics and Communications Engineering at
            VNU University of Science Ho Chi Minh (2019 - 2023). Besides, I am
            really passionate about <TextHighlight text="Javascript" /> and{" "}
          ...
          <p>
            ...
            is not difficult. I searched many different sources to learn about
